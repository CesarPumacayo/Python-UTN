...
personaje_quieto = [
                    pygame.image.load("juego\Quieto\\4.png"),
                    pygame.image.load("juego\Quieto\\5.png"),
                    pygame.image.load("juego\Quieto\\6.png"),
                    pygame.image.load("juego\Quieto\\7.png")
                    ]

personaje_camina = [
                    pygame.image.load("juego\Camina\Adelante\\0.png"),
                    pygame.image.load("juego\Camina\Adelante\\1.png"),
                    pygame.image.load("juego\Camina\Adelante\\3.png"),
                    pygame.image.load("juego\Camina\Adelante\\5.png"),

                   ]
personaje_izquierda = girar_imagenes(personaje_camina, True, False)

personaje_salta =[pygame.image.load("juego\Salta\\0.png")]
